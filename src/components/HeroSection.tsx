        ...
        <div className="flex flex-row justify-between items-center text-lg">
          <div className="w-full lg:w-1/2 text-textWhite flex flex-col gap-10">
            <div className="text-3xl md:text-4xl lg:text-5xl">
              Hey there!
              <div className="mt-2">
                I'm <span className="text-textPrimary">Paritosh Sengar</span>
              </div>
            </div>
            <div className="text-base md:text-xl">
              Stepped into programming back in 2023, and now I'm a{" "}
              <span className="text-textPrimary">Full Stack Developer</span> with
          ...
          <div className="hidden lg:block  flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <SocialButtons
                url="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=paritosh4sengar@google.com"
